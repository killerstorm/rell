...
class LibSetTest: BaseRellTest(false) {
    ...
    @Test fun testAdd() {
        ...
        chkEx("{ $init val r = x.add(1); return r+' '+x; }", "text[false [1, 2, 3]]")
        chkEx("{ $init val r = x.add(2); return r+' '+x; }", "text[false [1, 2, 3]]")
        chkEx("{ $init val r = x.add(3); return r+' '+x; }", "text[false [1, 2, 3]]")
    ...
    @Test fun testAddAll() {
        val init = "val x = set([1, 2, 3]);"
        chkEx("{ $init val r = x.addAll(set<integer>()); return r+' '+x; }", "text[false [1, 2, 3]]")
        chkEx("{ $init val r = x.addAll(list<integer>()); return r+' '+x; }", "text[false [1, 2, 3]]")
        chkEx("{ $init val r = x.addAll(set<integer>([1, 2, 3])); return r+' '+x; }", "text[false [1, 2, 3]]")
        chkEx("{ $init val r = x.addAll(list<integer>([1, 2, 3])); return r+' '+x; }", "text[false [1, 2, 3]]")
        chkEx("{ $init val r = x.addAll(set<integer>([3, 4, 5])); return r+' '+x; }", "text[true [1, 2, 3, 4, 5]]")
        chkEx("{ $init val r = x.addAll(list<integer>([3, 4, 5])); return r+' '+x; }", "text[true [1, 2, 3, 4, 5]]")
    ...
    @Test fun testRemoveAll() {
        val init = "val x = set([1, 2, 3]);"
        chkEx("{ $init val r = x.removeAll(set([0])); return ''+r+' '+x; }", "text[false [1, 2, 3]]")
        chkEx("{ $init val r = x.removeAll(set([1])); return ''+r+' '+x; }", "text[true [2, 3]]")
        chkEx("{ $init val r = x.removeAll(set([2])); return ''+r+' '+x; }", "text[true [1, 3]]")
        chkEx("{ $init val r = x.removeAll(set([3])); return ''+r+' '+x; }", "text[true [1, 2]]")
        chkEx("{ $init val r = x.removeAll([0]); return ''+r+' '+x; }", "text[false [1, 2, 3]]")
        chkEx("{ $init val r = x.removeAll([2]); return ''+r+' '+x; }", "text[true [1, 3]]")
        chkEx("{ $init val r = x.removeAll([1, 2, 3]); return ''+r+' '+x; }", "text[true []]")
        chkEx("{ $init val r = x.removeAll([1, 3]); return ''+r+' '+x; }", "text[true [2]]")
