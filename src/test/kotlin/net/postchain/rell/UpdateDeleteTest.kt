...
class UpdateDeleteTest: BaseRellTest() {
    ...
    @Test fun testBugGamePlayerSubExpr() {
        ...
        tst.insert("c0_user", "name,games_total,games_won", "1,'Bob',3,2")
        tst.insert("c0_user", "name,games_total,games_won", "4,'Alice',6,5")
        tst.insert("c0_game", "player_1,player_2", "7,1,4")
