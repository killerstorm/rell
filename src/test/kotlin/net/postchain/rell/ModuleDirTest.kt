...
class ModuleDirTest: BaseRellTest(false) {
    ...
    @Test fun testFilesDoNotSeeEachOthersImports() {
        ...
        file("d/d1.rell", "import a; function g(): integer = a.f();")
        chkImp("import b;", "b.g()", "ct_err:b/b2.rell:unknown_name:a")
        chkImp("import c;", "c.p()", "int[56088]")
        chkImp("import c;", "c.q()", "int[97047]")
        chkImp("import d;", "d.g()", "int[123]")
    }

    @Test fun testFilesDoNotSeeEachOthersImports2() {
        file("a.rell", "module; function f(): integer = 123;")
        ...
        file("d/d1.rell", "import x: a; function g(): integer = x.f();")
        chkImp("import b;", "b.g()", "ct_err:b/b2.rell:unknown_name:x")
        chkImp("import c;", "c.p()", "int[56088]")
        chkImp("import c;", "c.q()", "int[97047]")
        chkImp("import d;", "d.g()", "int[123]")
    }

    @Test fun testImportsNoInterFileNameConflict() {
        ...
        file("e/e2.rell", "import a.x; function g(): integer = x.f();")

        chkImp("import c;", "c.g1()", "int[123]")
        chkImp("import c;", "c.g2()", "int[456]")
